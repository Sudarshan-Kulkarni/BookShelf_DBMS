...
def create_db():
    ...
    cur.execute("CREATE TABLE lending_section(LID integer ,ISBN int(10) ,av int(1) ,RID integer ,foreign key(ISBN) references books(ISBN));")
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    """
    cur.execute("CREATE TABLE reading_section(RID integer ,ISBN int(10) , due_date date, extn_count int default 0 ,LID integer ,foreign key(ISBN) references books(ISBN));")
    ...
    cur.execute("CREATE TABLE incomplete_transaction(RID integer ,ISBN int(10) ,LID integer ,foreign key(ISBN) references books(ISBN));")
